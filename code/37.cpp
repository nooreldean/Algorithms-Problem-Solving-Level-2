...
void copyarrywithaddarrayelemint(int arry1[100],int arry2[100],int arrylength,int &arry2length)
{
...
int main()
{
   srand((unsigned int)time(NULL));
    ...
    copyarrywithaddarrayelemint(arry, arry2 ,arrlength , arry2length);
