...
void printstringarray(string arr[100], int leangth)
{
...
void fillarraywithrandomkeys(string arr[100], int length)
{
...
int main()
{
     ...
     string arr[100];
     int length=0;
     length=readpositivenumber("Pleaes enter how many keys to generate? \n");
     fillarraywithrandomkeys(arr,length);
